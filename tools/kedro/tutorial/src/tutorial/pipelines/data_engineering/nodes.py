...
def preprocess(iris: pd.DataFrame, random_state: int) -> List[Any]:
    X = iris[["sepal_length", "sepal_width", "petal_length", "petal_width"]]
    y = iris["species"]

    # Cut outliers
    clf = IsolationForest(max_samples=len(iris), random_state=random_state)
    clf.fit(X)
...
def split_data(X: pd.DataFrame, y: pd.DataFrame, params: Dict[str, Any]) -> Dict[str, Any]:
